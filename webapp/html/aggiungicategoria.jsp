			...
			if(request.getAttribute(Costanti.KEY_ERRORE_PRODOTTO)!=null){
                ...
                %>
                    ...
                    <div id="contenitore-form-agg" style="display: flex; flex-direction: column; align-items: center;">
                        <form id="aggiungi-form-1" action="<%=request.getContextPath()+"/insertcategoria"%>" method="post">
                            <label for="categoria" style="text-align: center;">Categoria</label>
                            <input type="text" name="<%= Costanti.CATEGORIA_NOME %>">
          
                            
                            <button type="submit" class="cerca-opz">Aggiungi Categoria</button>
