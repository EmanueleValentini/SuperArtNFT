...
@WebServlet("/passocategoriesearch")
public class PassoCategorieSearchServlet extends HttpServlet{
	@Override
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			req.getRequestDispatcher("/html/cercacategoria.jsp").forward(req, resp);
