...
@WebServlet("/ripristinacat")
public class RipristinaCategoriaServlet extends HttpServlet {


	public RipristinaCategoriaServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (utente.getRuolo().getNomeRuolo().equals(Costanti.ADMIN)) {
				String catNome = request.getParameter(Costanti.CATEGORIA_NOME);
				bl.ripristinaCategoria(catNome);
				messaggioErrore="Categoria ripristinata con successo!";
			}
